...
export const DeleteSaleModal = ({ isOpen, onClose, onSuccess, sale }: DeleteSaleModalProps) => {
    ...
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-4">
      <div className="bg-[#14181f] rounded-2xl border border-gray-700/50 w-full max-w-md p-6 shadow-2xl shadow-red-500/20">
        ...
        <p className="text-gray-300 mb-6">
          Are you sure you want to delete this sale (OR #{sale.or_number})? This action cannot be undone.
        </p>
